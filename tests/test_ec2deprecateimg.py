...
test_depr_date_data = [
    ("", 1, today_tag, (today + one_month_delta).strftime('%Y%m%d')),
    ("", 6, today_tag, (today + six_month_delta).strftime('%Y%m%d')),
    ("20220707", 6, '20220707', '20230107'),
    ("20221231", 1, '20221231', '20230131'),
    ("20220331", 1, '20220331', '20220430'),
]


@pytest.mark.parametrize(
    "depr_date,depr_period,expected_depr_date,expected_del_date",
    test_depr_date_data
)
